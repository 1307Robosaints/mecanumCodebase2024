...
driveFrontLeft = new CANSparkMax(4, MotorType.kBrushless);
 //addChild("driveFrontLeft",driveFrontLeft);
 driveFrontLeft.setInverted(true);

driveBackLeft = new CANSparkMax(3, MotorType.kBrushless);
 //addChild("driveBackLeft",driveBackLeft);
 driveBackLeft.setInverted(true);

driveFrontRight = new CANSparkMax(1, MotorType.kBrushless);
 //addChild("driveFrontRight",driveFrontRight);
 driveFrontRight.setInverted(false);

driveBackRight = new CANSparkMax(2, MotorType.kBrushless);

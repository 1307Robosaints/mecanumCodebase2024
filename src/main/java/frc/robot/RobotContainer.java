...
joystickButton6.whileTrue(new IntakeFlipUp(m_intake).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        
final JoystickButton joystickButton5 = new JoystickButton(joystick1, 5);        
joystickButton5.whileTrue(new IntakeEatCD(m_intake).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        
final JoystickButton joystickButton4 = new JoystickButton(joystick1, 4);        
joystickButton4.whileTrue(new IntakeFlipDown(m_intake).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        
final JoystickButton joystickButton3 = new JoystickButton(joystick1, 3);        
joystickButton3.whileTrue(new IntakeSpitCD(m_intake).withInterruptBehavior(InterruptionBehavior.kCancelSelf));

...
// Joysticks
private final PS4Controller pS4Controller1 = new PS4Controller(2);
...
joystickButton6.whileTrue(new ClimbUp(m_climber).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        
final JoystickButton joystickButton11 = new JoystickButton(joystick1, 11);        
joystickButton11.whileTrue(new IntakeEatCD(m_intake, m_sensors).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        
final JoystickButton joystickButton4 = new JoystickButton(joystick1, 4);        
joystickButton4.whileTrue(new ClimbDown(m_climber).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
   
final JoystickButton joystickButton9 = new JoystickButton(joystick1, 9);        
joystickButton9.whileTrue(new IntakeSpitCD(m_intake).withInterruptBehavior(InterruptionBehavior.kCancelSelf));

final JoystickButton joystickButton3 = new JoystickButton(joystick1, 3);        
joystickButton3.whileTrue(new IntakeFlipUp(m_intake).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
